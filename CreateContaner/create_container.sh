...
# ======================================================================
# 
# 👨2025💻 Автор: Антонов Евгений
# 📧 Контакты: ae@dcea.ru
# 🔗 Репозиторий: https://github.com/onegin/proxmox-automation-suite
# 
# 📜 ЛИЦЕНЗИЯ:
...
# 📄 GNU GPL v3 + Коммерческие ограничения
# 🔗 Обязательная ссылка на оригинальный репозиторий
# 👥 Производные работы должны сохранять лицензию
# 
# ⚠️  ПРЕДУПРЕЖДЕНИЕ:
# 🔒 Используйте на свой страх и риск
# 📊 Автор не несет ответственности за последствия
# 🛠️ Рекомендуется тестирование в тестовой среде
# 
# ======================================================================
# 🎯 НАЗНАЧЕНИЕ СКРИПТА:
# 🐳 Автоматическое создание LXC-контейнеров в Proxmox VE
# ⚡ Интерактивный и автоматический режимы работы
# 🔧 Настройка ресурсов, сети, безопасности
# 🖥️ Поддержка VNC и графической среды
# 
# 🚀 ВОЗМОЖНОСТИ:
# ✅ Выбор шаблона из доступных образов
# ⚙️ Настройка vCPU, RAM, дискового пространства
# 🌐 Конфигурация сети (DHCP/статический IP, VLAN)
# 🔐 Безопасная генерация паролей root
# 🖥️ Установка графической среды (VNC)
